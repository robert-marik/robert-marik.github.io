...
úloh. Ty nejsou povinné, ale značně usnadní situaci u závěrečné zkoušky. <https://um.mendelu.cz/webwork2/MTK_2023_LS/>
...
tištěnému textu. 
* Učebnice [Došlá, Z., Liška, P., Matematika pro
...
* **Závěrečná písemná zkouška:**
    * Ukázkou zadání jsou [písemky ze zimního semestru 2021/2022](https://user.mendelu.cz/marik/mtk/pisemky/2021_ZS/). 
...
* **Staré písemky**
    * Staré offline písemky jsou <https://user.mendelu.cz/marik/mtk/pisemky/2019_ZS/> a <https://user.mendelu.cz/marik/mt/pisemka> (ještě starší <https://user.mendelu.cz/marik/mt/pisemka_2019/>, ale jedná se o písemky, které byly psány bez možnosti používat vlastní poznámky). Proto bude formulace teoretických otázek taková, aby bylo zohledněno to, že je možné používat literaturu. Také písemky obsahují některou látku, která již není aktuální, například průběh funkce.
    * Online písemky ze zimního COVIDového semestru 2020 jsou <https://user.mendelu.cz/marik/mtk/pisemky/2020_ZS>. Videokomentáře a řešení některých online písemek jsou v [playlistu s prací v systému WeBWorK](https://www.youtube.com/playlist?list=PLTcG-zIT2ivXZpHu2yL2oqsdKRCF87QjL). Můžete si projít, ale s online formou se nepočítá, pokud nás k tomu nedonutí epidemiologická situace.
